...
def main():
    ...
    color_threshold = 500  # 색상을 감지하기 위한 픽셀 임계값 설정
    interval_frames = 10   # 색상을 감지할 프레임 간격 설정
    current_frame = 0
    ...
    while True:
        ...
        current_frame = (current_frame + 1) % interval_frames
